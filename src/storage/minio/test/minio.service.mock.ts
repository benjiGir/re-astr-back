...
import type { FileMetadata, UploadResult } from '../minio.service'
...
export const mockPresignedUrl =
  'https://minio.example.com/test-bucket/test-file.png?X-Amz-Expires=3600'
